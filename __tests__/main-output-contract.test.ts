...
const EXPECTED_OUTPUT_KEYS = {
  ...
  download: ['bytes-transferred', 'content-sha1', 'file-name', 'files-downloaded', 'summary-json'],
  sync: [
    'bytes-transferred',
    'files-deleted',
    'files-downloaded',
  ...
  copy: ['bytes-transferred', 'file-id', 'file-name', 'summary-json'],
  delete: ['files-deleted', 'summary-json'],
  presign: ['file-name', 'files-listed', 'presigned-url', 'summary-json'],
  list: ['files-listed', 'summary-json'],
  hide: ['file-id', 'file-name', 'summary-json'],
  unhide: ['file-id', 'file-name', 'summary-json'],
  verify: ['file-name', 'local-sha1', 'remote-sha1', 'summary-json', 'verified'],
  retention: ['file-id', 'file-name', 'summary-json'],
  head: ['bytes-transferred', 'content-sha1', 'file-id', 'file-name', 'summary-json'],
  purge: ['files-deleted', 'summary-json'],
