...
- Add signed GitHub Artifact Attestations for the release `dist/index.js` bundle, upload the attested bundle plus a SHA-256 checksum as release assets, and document `gh attestation verify` provenance checks for consumers. ([#19](https://github.com/backblaze-labs/b2-action/issues/19))
