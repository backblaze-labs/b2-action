...
| Docs & legibility | A | `action.yml` ↔ README sync, strict TypeDoc, markdown/link/spell lints, and the AGENTS.md map over this system of record ([DEVELOPMENT.md](../DEVELOPMENT.md#ci-gates)) | Freshness relies on review; no scheduled doc-gardening job (TD-0005) |
